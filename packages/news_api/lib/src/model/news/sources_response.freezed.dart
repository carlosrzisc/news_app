...
mixin _$SourcesResponse {
  ...
  List<Source>? get articles => throw _privateConstructorUsedError;
...
abstract class $SourcesResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? status, List<Source>? articles});
}
...
class _$SourcesResponseImpl implements _SourcesResponse {
  _$SourcesResponseImpl({this.status, final List<Source>? articles})
      : _articles = articles;
  ...
  @override
  final String? status;
  final List<Source>? _articles;
  @override
  List<Source>? get articles {
  ...
  @override
  String toString() {
    return 'SourcesResponse(status: $status, articles: $articles)';
  }
...
abstract class _SourcesResponse implements SourcesResponse {
  factory _SourcesResponse(
      {final String? status,
      final List<Source>? articles}) = _$SourcesResponseImpl;
