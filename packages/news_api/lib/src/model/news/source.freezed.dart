...
class _$SourceImpl implements _Source {
  ...
  @override
  String toString() {
    return 'Source(id: $id, name: $name, description: $description, url: $url, category: $category, country: $country)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, description, url, category, country);
