...
class AppColors {
  ...
  /// Primary
  static const primaryLighter = Color(0xFFFCC9A7);
  static const primaryLight = Color(0xFFFAAA75);
  static const primary = Color(0xFFEE8D4C);
  static const primaryDark = Color(0xFFB35B20);
  static const primaryDarker = Color(0xFF803909);
  static const accent = Color(0xFFF9DB5C);
